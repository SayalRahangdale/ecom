...
<body>
  <div class="container-fluid">
    <div class="col-md-12">
      <div class="row">
        <h1 class="text-warning font-monospace text-center my-3">FANS</h1>
        <?php
        include 'Config.php';
        $Record = mysqli_query($conn, "SELECT * FROM `tblproduct` WHERE PCategory='fans'"); // ✅ फक्त लॅपटॉपसाठी डेटा आणला
